    ...
    dragSort () {
      ...
      const sortable = new Sortable(el, {
        ...
        onStart: evt => {
          ...
          if (this.dragScope === 'first' && index >= 3) {
            this.sortable.cancel();
          } else if (this.dragScope === 'second' && index < 3) {
            this.sortable.cancel();
          }
        },
        onEnd: evt => {
          const index = evt.oldIndex;
          if (this.dragScope === 'first' && index < 3 && evt.newIndex >= 3) {
            this.sortable.cancel();
          } else if (this.dragScope === 'second' && index >= 3 && evt.newIndex < 3) {
            this.sortable.cancel();
          } else {
