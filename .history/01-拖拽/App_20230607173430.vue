  ...
  methods: {
    dragSort () {
      ...
      onEnd: function (evt) {
        ...
        if (previousItem && previousItem.classList.contains('sortable-item')) {
          item.parentNode.insertBefore(item, previousItem);
        } else if (nextItem && nextItem.classList.contains('sortable-item')) {
          item.parentNode.insertBefore(item, nextItem.nextSibling);
        }
      }
